...
public class NetworkManager : MonoBehaviourPunCallbacks
{
    ...
    public Text AmericanMusclePropertyText;
    public Text GTRPropertyText;
    ...
    public override void OnJoinedRoom()
    {
        ...
        if (PhotonNetwork.CurrentRoom.CustomProperties.TryGetValue("gm", out gameModeName))
        {
            ...
            if (PhotonNetwork.CurrentRoom.CustomProperties.ContainsValue("rc"))
            {
                ...
                AmericanMusclePropertyText.text = " ";
                GTRPropertyText.text = " ";
                SportsPropertyText.text = " ";
            }
            else if (PhotonNetwork.CurrentRoom.CustomProperties.ContainsValue("dr"))
            {
                GameModeText.text = "Death Race Mode";
                AmericanMusclePropertyText.text = "HP: 100 | Weapon: Laser";
                GTRPropertyText.text = "HP: 100 | Weapon: Missile";
                SportsPropertyText.text = "HP: 100 | Weapon: Laser";
            }
        }
